...
static const	int _CONFIG_maxSBins = 2048;			// TODO: dependent on tBins, this is acutalle sBinsSize/beta
// TODO: assert that spins are integeres starting with 0 (indexing!)
static const    int _CONFIG_spins = 2;			// number of possible spins, always == 2, => enum?
...
// 2 pi (n+1)/ beta
//typedef Mat MatrixT;
// <double tau,bool s> 0 for spin -1 (down), 1 for spin 1(up)
